        ...
        <div class="mb-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <x-text-input type="date" name="birth_date" id="birth_date" value="{{ old('birth_date', $user->birth_date) }}" class="mt-1 block w-full rounded-lg border-green-600 shadow-sm focus:ring-2 focus:ring-green-500" required />
                </div>
                ...
                <!-- Address Fields -->
                <div>
                    <x-input-label for="barangay_id" :value="__('Section')" class="text-lg font-semibold text-gray-800"/>
                ...
                <div>
                    <x-input-label for="street" :value="__('Grade Level')" class="text-lg font-semibold text-gray-800"/>
